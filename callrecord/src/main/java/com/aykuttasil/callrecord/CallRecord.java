...
public class CallRecord {
    ...
    public void changeAudioSource(int audioSource) {
        ...
        //Log.i("CallRecord", "New dir path: " + audioSource);
    }

    public void changeAudioEncoder(int audioEncoder) {
        ...
        //Log.i("CallRecord", "New dir path: " + audioEncoder);
    }
    ...
    public void changeOutputFormat(int outputFormat) {
        ...
        //Log.i("CallRecord", "New dir path: " + outputFormat);
    }
    ...
    public static class Builder {
        ...
        public Builder(Context context) {
            ...
            //PrefsHelper.writePrefInt(mContext, PREF_AUDIO_SOURCE, MediaRecorder.AudioSource.VOICE_CALL);
            //PrefsHelper.writePrefInt(mContext, PREF_AUDIO_SOURCE, MediaRecorder.AudioSource.MIC);
            //PrefsHelper.writePrefInt(mContext, PREF_AUDIO_SOURCE, MediaRecorder.AudioSource.CAMCORDER);
            //PrefsHelper.writePrefInt(mContext, PREF_AUDIO_SOURCE, MediaRecorder.AudioSource.VOICE_DOWNLINK);
            //PrefsHelper.writePrefInt(mContext, PREF_AUDIO_SOURCE, MediaRecorder.AudioSource.DEFAULT);

            PrefsHelper.writePrefInt(mContext, PREF_AUDIO_ENCODER, MediaRecorder.AudioEncoder.AMR_NB);
            //PrefsHelper.writePrefInt(mContext, PREF_AUDIO_ENCODER, MediaRecorder.AudioEncoder.AAC);

            PrefsHelper.writePrefInt(mContext, PREF_OUTPUT_FORMAT, MediaRecorder.OutputFormat.AMR_NB);
            //PrefsHelper.writePrefInt(mContext, PREF_OUTPUT_FORMAT, MediaRecorder.OutputFormat.MPEG_4);
